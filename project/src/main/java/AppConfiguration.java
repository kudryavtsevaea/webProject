    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.netcracker.project");
                servletContext.setInitParameter("tapestry.development-modules", "com.netcracker.project.services.DevelopmentModule");
