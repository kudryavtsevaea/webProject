package com.netcracker.project.pages
...
import com.netcracker.project.services.QaModule
...
class LoginSpec extends Specification {
    ...
    def setupSpec() {
        tester = new TapestryTester("com.netcracker.project", "app", "src/main/webapp", QaModule.class)
    }
