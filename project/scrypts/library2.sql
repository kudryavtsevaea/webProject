...
insert book(author, book_name, year_of_publishing, amount_of_pages, is_handed_out) valuesbook_turnover ('А.С. Пушкин', 'Капитанская дочка', 1936, 384, false);
...
create view book_turnover_with_info3 as
select book_turnover_with_info.reader_id, reader.readerName, book_turnover_with_info.inventory_number, book_turnover_with_info.author, 
book_turnover_with_info.book_name, book_turnover_with_info.year_of_publishing, 
book_turnover_with_info.amount_of_pages, book_turnover_with_info.date_of_getting,  
book_turnover_with_info.is_handed_out
from reader inner join  book_turnover_with_info on  book_turnover_with_info.reader_id = reader.id;