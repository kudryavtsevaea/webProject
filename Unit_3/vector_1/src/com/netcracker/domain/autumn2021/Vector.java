...
public class Vector implements Functionable{
    ...
    Vector(Point3D a, Point3D b){
        setA(a);
        setB(b);
        //  System.out.println("Вектор с координатами " + a.toString() +
          //      "; " + b.toString() + " был создан из конструктора");
    }
    ...
    public Vector vectorMult(Vector vector1, Vector vector2){
        ...
        System.out.println("начало вектора = " + point1.toString());
        System.out.println("конец вектора = " + point2.toString());
